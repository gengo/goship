...
func TestRenderDetailPublic(t *testing.T) {
	...
	want := template.HTML("<td><a target=_blank href=https://travis-ci.org/test/test_public><img src=https://travis-ci.org/test/test_public.svg?branch=master></img></a></td>")
	if want != got {
		t.Errorf("Want %#v, got %#v", want, got)
	}
}
...
func TestRenderDetailPrivate(t *testing.T) {
	...
	want := template.HTML("<td><a target=_blank href=https://magnum.travis-ci.com/test/test_private><img src=https://magnum.travis-ci.com/test/test_private.svg?token=test_token&branch=master></img></a></td>")
	if want != got {
		t.Errorf("Want %#v, got %#v", want, got)
	}
}
